...
#if !(LINUX_VERSION_IN_RANGE(5,10,70, 5,11,0) || CUSTOM_KERN_1_RELEASE_VERSION_IS_GEQ(8,6656) || CUSTOM_KERN_3_RELEASE_VERSION_IS_GEQ(136,12,0) || defined(CONFIG_SYNO_EPYC7003NTB))
/*
